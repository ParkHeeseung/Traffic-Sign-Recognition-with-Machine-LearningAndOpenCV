...
int main(){
  ...
  crossworkImg = imread( "/home/suki/바탕화면/Traffic Sign Recognition/image/black_background/2.png", CV_LOAD_IMAGE_GRAYSCALE );
  curveImg = imread( "/home/suki/바탕화면/Traffic Sign Recognition/image/black_background/3.png", CV_LOAD_IMAGE_GRAYSCALE );
  dynamicObstacleImg = imread( "/home/suki/바탕화면/Traffic Sign Recognition/image/black_background/4.png", CV_LOAD_IMAGE_GRAYSCALE );
  ...
  uTurnImg = imread( "/home/suki/바탕화면/Traffic Sign Recognition/image/black_background/제목 없음.png", CV_LOAD_IMAGE_GRAYSCALE );
